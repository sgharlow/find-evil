...
555 tests (554 passing, 1 skipped), organized by component:
...
| Doc consistency | 50 | README/CLAUDE.md/submission accuracy, tool registry cross-reference, package metadata |
...
| 2 | Demo Video | **https://youtu.be/EeMW7Uhc-GQ** (≤5 min) · `demo/video_demo.py` · `demo/VIDEO_SCRIPT.md` |
