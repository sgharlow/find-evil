...
| **Demo Video (≤5 min)** | https://youtu.be/EeMW7Uhc-GQ |
...
| 4 | Test strategy + results (555 tests) | [`README.md`](./README.md) Test Suite section + `pytest --collect-only` |
| 5 | Demo video + scripts | **Video: https://youtu.be/EeMW7Uhc-GQ (≤5 min)** · [`demo/run_investigation.py`](./demo/run_investigation.py) · [`demo/tamper_demo.py`](./demo/tamper_demo.py) · [`demo/VIDEO_SCRIPT.md`](./demo/VIDEO_SCRIPT.md) |
